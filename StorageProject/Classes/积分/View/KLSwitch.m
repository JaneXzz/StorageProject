...
#define UIColorFromRGBA1(rgbValue,A) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:A]
...
//    [_thumb setBackgroundColor:UIColorFromRGBA1(0x20FFFC,1)];
    if (_on == YES) {
        [_thumb setBackgroundColor:UIColorFromRGBA1(0x3C51D9,1)];
    }else{
        [_thumb setBackgroundColor:UIColorFromRGBA1(0x868686,1)];
    }
