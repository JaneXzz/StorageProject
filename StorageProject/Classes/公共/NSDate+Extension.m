...
+(NSString*)weekdayStringFromDate:(NSDate*)inputDate {
    ...
    NSInteger weekdayNumber = [calendar component:NSCalendarUnitWeekday fromDate:inputDate];
    return [weekdays objectAtIndex:weekdayNumber];
...
+(NSString *)dateConversionString:(NSDate *)date andDateFormatStr:(NSString *)str{
    NSDateFormatter *dateFormatter=[[NSDateFormatter alloc]init];//创建一个日期格式化器
    dateFormatter.dateFormat=str;//指定转date得日期格式化形式
    return [dateFormatter stringFromDate:date];
}
